...
through platform-side onboarding once - see [../onboarding.md](../onboarding.md) if
you're setting up a brand new app for the first time (GitHub App installation, initial
chart install, namespace provisioning). This guide is about the part you'll actually
repeat: writing and iterating on `cicd.yaml`.
